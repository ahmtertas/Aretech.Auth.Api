...
{
	public sealed class DatabaseCacheServices : IDatabaseCacheService
	{
		private readonly IRedisConfiguration _redisConfiguration;
		private readonly IRedisDatabase _cache;

		public RedisDatabase db => RedisDatabase.DB2;

		public DatabaseCacheServices(IRedisConfiguration redisConfiguration, IRedisClient redisClient)
		{
