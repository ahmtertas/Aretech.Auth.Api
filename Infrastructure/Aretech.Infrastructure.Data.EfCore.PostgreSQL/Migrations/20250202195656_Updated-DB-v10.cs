...
{
    /// <inheritdoc />
    public partial class UpdatedDBv10 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("42ca9444-25b2-477d-bea7-ac5c5b8a0a2d"), new Guid("00000000-0000-0000-0000-000000000000"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("00000000-0000-0000-0000-000000000000"), null, "ar3t3ch@gmail.com", 0, "Süper", "", true, false, null, "Admin", null, "YynlP+hHfnhLhTJKeHDdpsYUSKQGrtlEoB8w4wVpY01roBTg+z6aI+6Iw4QMHAcc", "5452158345", null, null, false, new Guid("00000000-0000-0000-0000-000000000000"), null, "superadmin" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "Account",
                keyColumn: "Id",
                keyValue: new Guid("42ca9444-25b2-477d-bea7-ac5c5b8a0a2d"));
